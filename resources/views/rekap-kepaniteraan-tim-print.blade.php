...
<head>
    <meta charset="UTF-8">
    <title>Cetak – Rekap Kepaniteraan &amp; Tim</title>
    <style>
        @page {
...
@endphp
<div class="{{ $isLast ? 'block-page' : 'block-page' }}">

    {{-- Judul --}}
    <div class="blk-title">REKAPITULASI HONORARIUM BIAYA PENYELESAIAN PERKARA {{ $block['title'] }}</div>
    <div class="blk-subtitle">PADA KAMAR {{ $block['kamar'] }} ( Sebanyak {{ number_format($jml, 0, ',', '.') }} Perkara )</div>
