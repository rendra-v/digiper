...
# --- 1. DATE CALCULATION & HOLIDAY FILTERING FOR EXACTLY 140 DAYS (03/02/2026 s/d 03/08/2026) ---
...
# --- GENERATE LOGBOOK FILES FOR 140 DAYS ---
def generate_logbook_files(role, name, npm, logbook_fname):
    ...
    md_content += f"**Total Hari Kerja Efektif:** 140 Hari (Jam kerja: 8 jam/hari)  \n"
    md_content += f"**Total Jam Magang:** 1.120 Jam (Lulus syarat minimal 1.035 jam, kelebihan 85 jam)  \n"
...
<body>
<div class="container">
    <h1>LOGBOOK LAPORAN KEGIATAN MAGANG — 140 HARI KERJA EFEKTIF (1.120 JAM)</h1>
    <div class="info">
        ...
        <b>Total Hari Kerja:</b> 140 Hari Kerja Efektif &times; 8 Jam = <b>1.120 Jam</b> (Syarat Minimal: 1.035 Jam | Kelebihan: 85 Jam)<br>
...
"""
    ...
    doc.save(docx_path)
    print(f"Generated Logbook (140 Days): {docx_path}")

# --- 4. GENERATE DAFTAR HADIR FILES FOR 140 DAYS ---
...
<div class="container">
    ...
    <div class="info">
        ...
        <b>NPM:</b> {npm}<br>
        <b>Peran / Posisi:</b> {role}<br>
        <b>Total Kehadiran:</b> 140 Hari Hadir (100% Hadir / 1.120 Jam)
    </div>
    <table>
        <thead>
            <tr>
